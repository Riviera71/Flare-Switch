...
{
	config.resize(39);
	setConfigDefault(0,  "fullscreen",          &typeid(fullscreen),          "1",            &fullscreen,          "fullscreen mode. 1 enable, 0 disable.");
	setConfigDefault(1,  "resolution_w",        &typeid(screen_w),            "1920",          &screen_w,            "display resolution. 640x480 minimum.");
	setConfigDefault(2,  "resolution_h",        &typeid(screen_h),            "1080",          &screen_h,            "");
	...
	setConfigDefault(16, "joystick_deadzone",   &typeid(joy_deadzone),        "3000",          &joy_deadzone,        "");
	...
	setConfigDefault(20, "mouse_aim",           &typeid(mouse_aim),           "0",            &mouse_aim,           "use mouse to aim. 1 enable, 0 disable.");
	setConfigDefault(21, "no_mouse",            &typeid(no_mouse),            "1",            &no_mouse,            "make using mouse secondary, give full control to keyboard. 1 enable, 0 disable.");
	setConfigDefault(22, "show_fps",            &typeid(show_fps),            "1",            &show_fps,            "show frames per second. 1 enable, 0 disable.");
